...
<View style={s.profileHero}><View style={s.profileAvatarWrap}><View style={s.profileAvatarCircle}><Text style={s.profileAvatarInitial}>{selectedPlayer.slice(0,1).toUpperCase()}</Text></View></View><View style={s.profileHeroRight}><Text style={s.profileBigName}>{selectedPlayer.toUpperCase()}</Text>{profilePlayerRecord?.display_name&&String(profilePlayerRecord.display_name).toLowerCase()!==String(selectedPlayer).toLowerCase()?<Text style={s.profileRealName}>{String(profilePlayerRecord.display_name)}</Text>:null}<View style={s.profileAwardsLarge}><AwardsOnly name={selectedPlayer}/></View></View></View>
