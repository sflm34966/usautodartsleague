...
useEffect(()=>{if(signedIn&&tab==="PlayerStats"&&selectedPlayer){refreshSelectedPlayerStats(selectedPlayer,selectedSeasonId||currentSeasonId||0,selectedPlayerId);}},[tab,signedIn,selectedPlayer,selectedPlayerId,selectedSeasonId,currentSeasonId,serverStandings,serverMatches,serverPlayers,serverLeagueHistoryMatches]);
